...
angular.module('copayApp').config(function(historicLogProvider, $provide, $logProvider, $stateProvider, $urlRouterProvider, $compileProvider, $ionicConfigProvider) {
    ...
    $stateProvider
        ...
        .state('tabs.buyandsell.coinsri', {
            url: '/coinsri/:code',
            cache: false,
            views: {
                'tab-home@tabs': {
                    controller: 'coinsriController',
                    controllerAs: 'coinsri',
                    templateUrl: 'views/coinsri.html'
                }
            }
        })
        ...
        .state('onboarding.landing', {
            ...
            views: {
                'onboarding': {
                    templateUrl: 'views/onboarding/landing.html',
        ...
        .state('onboarding.emailRegister', {
            url: '/Demo',
            views: {
                'onboarding': {
                    controller: 'demoControllers',
                    templateUrl: 'views/onboarding/emailRegister.html'
                }
            }
        })

        .state('onboarding.mobileRegister', {
            url: '/Mobile',
            views: {
                'onboarding': {
                    controller: 'mobileControllers',
                    templateUrl: 'views/onboarding/mobileRegister.html'
                }
            }
        })

        .state('onboarding.nameRegister', {
            url: '/Name',
            views: {
                'onboarding': {
                    controller: 'nameControllers',
                    templateUrl: 'views/onboarding/nameRegister.html'
                }
            }
        })
        ...
        .state('tabs.myProfile', {
            ...
            views: {
                'tab-settings@tabs': {
                    controller: 'myProfileControllers',
        ...
        .state('tabs.buySellOrderHistory', {
            url: '/buySellOrderHistory',
            cache:false,
            views: {
                'tab-home': {
                    controller: 'buySellOrderHistoryControllers',
                    templateUrl: 'views/buySellOrderHistory.html'
                }
            }
        })
        .state('tabs.detailedView', {
            url: '/buySellOrderHistoryDetails',
            views: {
                'tab-home': {
                    controller: 'buySellOrderHistoryDetails',
                    templateUrl: 'views/buySellOrderHistoryDetail.html'
                }
            }
        })
    //End New States Added



})
    .run(function($rootScope, $state, $location, $log, $timeout, startupService, fingerprintService, $ionicHistory, $ionicPlatform, $window, appConfigService, lodash, platformInfo, profileService, uxLanguage, gettextCatalog, openURLService, storageService, scannerService, configService, /* plugins START HERE => */ coinsriService, amazonService, bitpayCardService) {
                ...
                if (err)
                 {
                    ...
                    if(userId)
                    {
                     console.log("_______ lodash.isEmpty : ");
                        profileService.loadAndBindProfile(function (err) {
                            ...
                            if (lodash.isEmpty(profileService.getWallets())) {
                                ...
                                $state.go('tabs.home');
                                console.log("_________ tabs.home");
                            }
                        });
                    }
                    else if (err.message && err.message.match('NOPROFILE')) {
                        ...
                        if (lodash.isEmpty(profileService.getWallets())) {
                            ...
                            console.log("if wallet is not created");
                            $state.go('onboarding.landing');
                        } else {
