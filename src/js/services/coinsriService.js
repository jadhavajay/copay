...
angular.module('copayApp.services').factory('coinsriService', function($http, $log, $window, $filter, platformInfo, storageService, buyAndSellService, lodash, configService, txFormatService) {
  var root = {};
  var credentials = {};
  ...
  var register = function() {
      ...
      buyAndSellService.register({
        name: 'CoinSri',
        logo: 'img/coinsri_logo.png',
        location: 'India Only',
        sref: 'tabs.buyandsell.coinsri',
        configSref: 'tabs.preferences.coinsri',
        linked: '',
      });
  };
